...
TensorDesc outputDesc0_0[7] =
    {{ge::DT_FLOAT, ge::FORMAT_ND},
     ...
     {ge::DT_FLOAT, ge::FORMAT_ND},
     {ge::DT_FLOAT, ge::FORMAT_ND}};
SupportInfo list0_0 = {inputDesc0_0, 8, outputDesc0_0, 7};
...
[[maybe_unused]] uint32_t NNOPBASE_wkv7grad = 0U;
} // namespace
    ...
    aclOpExecutor **executor)
{
    ...
    static NnopbaseDfxId tilingId = {0x60000, "aclnnwkv7gradTiling", false};
    void *nnopExecutor;
    static void *executorSpace = NULL;
    const char *opType = "wkv7grad";
    char inputDesc[] = {1, 1, 1, 1, 1, 1, 1, 1};
    char outputDesc[] = {1, 1, 1, 1, 1, 1, 1};
    char attrDesc[] = {};
    ...
    NNOPBASE_ASSERT_NOTNULL_RETVAL(h);
    NNOPBASE_ASSERT_NOTNULL_RETVAL(o);
    NNOPBASE_ASSERT_NOTNULL_RETVAL(dkOut);
    NNOPBASE_ASSERT_NOTNULL_RETVAL(dvOut);
    NNOPBASE_ASSERT_NOTNULL_RETVAL(dwOut);
    NNOPBASE_ASSERT_NOTNULL_RETVAL(drOut);
    NNOPBASE_ASSERT_NOTNULL_RETVAL(daOut);
    NNOPBASE_ASSERT_NOTNULL_RETVAL(dbOut);
    NNOPBASE_ASSERT_NOTNULL_RETVAL(dhOut);
    ...
    *executor = reinterpret_cast<aclOpExecutor *>(nnopExecutor);
    ...
    NNOPBASE_ASSERT_OK_RETVAL(NnopbaseAddInput(*executor, a, 4));
    NNOPBASE_ASSERT_OK_RETVAL(NnopbaseAddInput(*executor, b, 5));
    NNOPBASE_ASSERT_OK_RETVAL(NnopbaseAddInput(*executor, h, 6));
    NNOPBASE_ASSERT_OK_RETVAL(NnopbaseAddInput(*executor, o, 7));
    NNOPBASE_ASSERT_OK_RETVAL(NnopbaseAddOutput(*executor, dkOut, 0));
    NNOPBASE_ASSERT_OK_RETVAL(NnopbaseAddOutput(*executor, dvOut, 1));
    NNOPBASE_ASSERT_OK_RETVAL(NnopbaseAddOutput(*executor, dwOut, 2));
    NNOPBASE_ASSERT_OK_RETVAL(NnopbaseAddOutput(*executor, drOut, 3));
    NNOPBASE_ASSERT_OK_RETVAL(NnopbaseAddOutput(*executor, daOut, 4));
    NNOPBASE_ASSERT_OK_RETVAL(NnopbaseAddOutput(*executor, dbOut, 5));
    NNOPBASE_ASSERT_OK_RETVAL(NnopbaseAddOutput(*executor, dhOut, 6));
    if (NnopbaseAddParamName != NULL) {
        ...
        NNOPBASE_ASSERT_OK_RETVAL(NnopbaseAddParamName(*executor, 4, "a", true));
        NNOPBASE_ASSERT_OK_RETVAL(NnopbaseAddParamName(*executor, 5, "b", true));
        NNOPBASE_ASSERT_OK_RETVAL(NnopbaseAddParamName(*executor, 6, "h", true));
        NNOPBASE_ASSERT_OK_RETVAL(NnopbaseAddParamName(*executor, 7, "o", true));
        NNOPBASE_ASSERT_OK_RETVAL(NnopbaseAddParamName(*executor, 0, "dkOut", false));
        NNOPBASE_ASSERT_OK_RETVAL(NnopbaseAddParamName(*executor, 1, "dvOut", false));
        NNOPBASE_ASSERT_OK_RETVAL(NnopbaseAddParamName(*executor, 2, "dwOut", false));
        NNOPBASE_ASSERT_OK_RETVAL(NnopbaseAddParamName(*executor, 3, "drOut", false));
        NNOPBASE_ASSERT_OK_RETVAL(NnopbaseAddParamName(*executor, 4, "daOut", false));
        NNOPBASE_ASSERT_OK_RETVAL(NnopbaseAddParamName(*executor, 5, "dbOut", false));
        NNOPBASE_ASSERT_OK_RETVAL(NnopbaseAddParamName(*executor, 6, "dhOut", false));
    }
