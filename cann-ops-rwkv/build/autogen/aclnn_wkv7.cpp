...
TensorDesc outputDesc0_0[2] =
    {{ge::DT_FLOAT, ge::FORMAT_ND},
     {ge::DT_FLOAT, ge::FORMAT_ND}};
SupportInfo list0_0 = {inputDesc0_0, 7, outputDesc0_0, 2};
...
[[maybe_unused]] uint32_t NNOPBASE_wkv7 = 0U;
} // namespace
    ...
    aclOpExecutor **executor)
{
    ...
    static NnopbaseDfxId tilingId = {0x60000, "aclnnwkv7Tiling", false};
    void *nnopExecutor;
    static void *executorSpace = NULL;
    const char *opType = "wkv7";
    char inputDesc[] = {1, 1, 1, 1, 1, 1, 1};
    char outputDesc[] = {1, 1};
    char attrDesc[] = {};
    ...
    *executor = reinterpret_cast<aclOpExecutor *>(nnopExecutor);
    ...
    NNOPBASE_ASSERT_OK_RETVAL(NnopbaseAddInput(*executor, hi, 6));
    ...
    if (NnopbaseAddParamName != NULL) {
        ...
        NNOPBASE_ASSERT_OK_RETVAL(NnopbaseAddParamName(*executor, 6, "hi", true));
